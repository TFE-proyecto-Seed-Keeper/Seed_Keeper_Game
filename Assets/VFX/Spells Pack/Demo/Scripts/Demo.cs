...
namespace ZakhanSpellsPack
{
    public class Demo : MonoBehaviour
    {
        ...
        private SpellsPackInputActions inputActions;

        private void OnEnable()
        {
            inputActions = new SpellsPackInputActions();
        }
        void Start()
        {
            ...
            if (inputActions != null) {
                ...
                inputActions.Keyboard.Next.performed += Next_performed;
                inputActions.Keyboard.Back.performed += Back_performed;
            }
